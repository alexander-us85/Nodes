...
class QDMGraphicsNode(QGraphicsItem):
    ...
    def __init__(self, node, parent=None):
        ...
        self.node = node
        self.content = self.node.content  # TODO: Maybe access the content as self.node.content?
        self.gr_content = None
        self._title_color = Qt.white
        self._title_font = QFont("Calibri")
        ...
        self._pen_selected = QPen(QColor("#fffcb103"))
    ...
    def paint(self, painter, style_option: QStyleOptionGraphicsItem, widget=None):
        # title
